...
import { mockTrips, getMockStats, TripData, transportModes, tripPurposes } from '@/data/mockData';
...
const Index = () => {
  ...
  const filteredTrips = useMemo(() => {
    ...
    // Date filtering would be implemented here with actual date comparison
    // For demo purposes, we'll use all trips
